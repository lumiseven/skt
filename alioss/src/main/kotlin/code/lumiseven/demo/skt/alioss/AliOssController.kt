...
class OssController {
    ...
    @Value("oss://lumi-alioss-bucket-private-3/test/oss-test.json")
    ...
    fun upload(): String {
        try {
            ...
            ossClient.putObject("lumi-alioss-bucket-private-3", "test/oss-test.json", stream)
        } catch (e: Exception) {
    ...
    fun download(): String {
        return try {
            val ossObject = ossClient.getObject("lumi-alioss-bucket-private-3", "test/oss-test.json")
